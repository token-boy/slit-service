...
export namespace Reflect {
  ...
  /**
    ...
    *
    */
  export declare function getMetadata<T>(metadataKey: any, target: any): T;
  ...
  /**
    ...
    *
    */
  export declare function getMetadata<T>(metadataKey: any, target: any, propertyKey: string | symbol): T;
